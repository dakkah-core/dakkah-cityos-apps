...
const styles = StyleSheet.create({
  ...
  exchangeChipActive: { backgroundColor: "rgba(49,130,206,0.2)", borderColor: "#3182ce" },
  exchangeChipTextActive: { color: "#3182ce" },
  ...
  exchangeDiffValue: { fontSize: 16, fontWeight: "800", color: "#d97706" },
  exchangeCredit: { color: "#0d9488" },
