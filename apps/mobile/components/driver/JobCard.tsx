  ...
  return (
    <Pressable style={[styles.card, isActive && styles.cardActive]} onPress={onPress}>
      <View style={styles.topRow}>
        <View style={[styles.typeBadge, { backgroundColor: job.type === "delivery" ? BRAND.blue : BRAND.amber }]}>
...
const styles = StyleSheet.create({
  ...
  cardActive: { borderColor: BRAND.teal, borderWidth: 2 },
  ...
  payoutText: { fontSize: 16, fontWeight: "700", color: BRAND.teal },
