...
const styles = StyleSheet.create({
  ...
  orderCountText: { color: "#0d9488", fontSize: 12, fontWeight: "700" },
  ...
  orderItemQty: { fontSize: 14, fontWeight: "700", color: "#0d9488", width: 28 },
  orderItemName: { fontSize: 14, color: "#fff", flex: 1 },
  orderItemNotes: { fontSize: 11, color: "#d97706", fontStyle: "italic" },
