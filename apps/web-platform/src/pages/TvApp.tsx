  ...
  return (
    ...
    <div
      style={{
        ...
        background: "linear-gradient(135deg, var(--dt-primary-navy) 0%, var(--dt-primary-navy-light) 50%, var(--dt-primary-navy) 100%)",
        color: "#ffffff",
            ...
            {CONTENT_SLIDES.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: 8,
                  borderRadius: 4,
                  background: i === activeSlide ? "var(--dt-primary-blue)" : "rgba(255,255,255,0.2)",
                  transition: "all 0.3s",
                  cursor: "pointer",
                }}
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: isFocused ? "3px solid var(--dt-primary-blue)" : "1px solid rgba(255,255,255,0.1)",
